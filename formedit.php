    ...
    <div class="container">
        <div class="row d-flex flex-row justify-content-center px-4 px-md-0">
            <div class="card col-12 col-md-6">
                <div class="card-body">
                    <form action="editriwayat.php" method="POST" class="px-4 d-flex flex-column justify-content-center">
                        <!-- Username input -->
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="text" id="namabuku" name="namabuku" class="form-control" value="<?php echo $data->namabuku;?>" />
                        </div>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="date" id="tanggalpeminjaman" name="tanggalpeminjaman" class="form-control" value="<?php echo $data->tanggalpeminjaman;?>"/>
                        </div>

                        <div class="form-outline mb-4">
                            <label class="form-label" for="tanggalpengembalian">Tanggal Pengembalian</label>
                            <input type="date" id="tanggalpengembalian" name="tanggalpengembalian" class="form-control" value="<?php echo $data->tanggalpeminjaman;?>"/>
                        </div>

                        <button type="submit" name= "ganti" class="btn btn-primary btn-block mb-4 ">Update</button>
